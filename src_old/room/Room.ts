...
import { BackgroundLayer } from "../../src/context/plugins/kaplay-background-more";
import { addRenderComps } from "../draw/primitive";
import * as EntityManager from "../entity/EntityManager";
import { hashPoint, javaHash } from "../../src/utils/hash";
...
export class Room implements Serializable {
    ...
    load() {
        ...
        ScriptHandler.addTask("setup1", 0, ["do", setup1, setup2], null, {});
    }
    unloaded() {
        this.depthTiles = [];
    }
